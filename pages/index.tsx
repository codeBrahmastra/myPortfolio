...
export default function Home({ blogs, profile }) {
  ...
  // const profile = {
  //   name: "Manoj K Mishra",
  //   image: "https://pps.whatsapp.net/v/t61.24694-24/117801931_2805836732983734_265806723490164116_n.jpg?ccb=11-4&oh=01_AdTdd_2wz3WhdTnY9KrlrPVh9Wocmjgqngkf9kMksCUpxg&oe=6426CAFF",
  //   fblink: "https://www.facebook.com/manojkumar.mishra.773"
  // }
  useEffect(() => {
    console.log("Thanks")
      ...
      <div><div
        ...
        <div className="bg-grey-50" id="blog">
          <div className="container py-16 md:py-20">
            ...
            <Link href={'/blogs'}>
              <div className="text-center">
                <button className="text-center border-2 border-solid px-5 py-2 m-5 bg-purple-500 text-white rounded-xl"> All Blogs
                </button>
              </div>
            </Link>
            {/* <h4
